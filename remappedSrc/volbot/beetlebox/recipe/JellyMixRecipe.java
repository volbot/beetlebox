...
public class JellyMixRecipe extends ShapelessRecipe {
    ...
    public RecipeSerializer<?> getSerializer() {
        return volbot.beetlebox.recipe.JellyMixRecipe.Serializer.INSTANCE;
    }
    ...
    implements RecipeSerializer<JellyMixRecipe> {
        ...
        public static final volbot.beetlebox.recipe.JellyMixRecipe.Serializer INSTANCE = new volbot.beetlebox.recipe.JellyMixRecipe.Serializer();
        ...
        public JellyMixRecipe read(Identifier identifier, JsonObject jsonObject) {
            ...
            DefaultedList<Ingredient> defaultedList = volbot.beetlebox.recipe.JellyMixRecipe.Serializer.getIngredients(JsonHelper.getArray(jsonObject, "ingredients"));

...
public class UpgradeRecipe extends ShapedRecipe {
	...
	public RecipeSerializer<?> getSerializer() {
		return volbot.beetlebox.recipe.UpgradeRecipe.Serializer.INSTANCE;
	}

	public static class Serializer implements RecipeSerializer<UpgradeRecipe> {

		public static final volbot.beetlebox.recipe.UpgradeRecipe.Serializer INSTANCE = new volbot.beetlebox.recipe.UpgradeRecipe.Serializer();
		...
		public UpgradeRecipe read(Identifier identifier, JsonObject jsonObject) {
			ShapedRecipe r = volbot.beetlebox.recipe.UpgradeRecipe.Serializer.SHAPED.read(identifier, jsonObject);
		...
		public UpgradeRecipe read(Identifier identifier, PacketByteBuf packetByteBuf) {
			ShapedRecipe r = volbot.beetlebox.recipe.UpgradeRecipe.Serializer.SHAPED.read(identifier, packetByteBuf);
			return new UpgradeRecipe(identifier, r.getGroup(), r.getCategory(), r.getWidth(), r.getHeight(),
					r.getIngredients(), ItemRegistry.UPGRADE_DORMANT.getDefaultStack());
		}
		...
		public void write(PacketByteBuf packetByteBuf, UpgradeRecipe shapedRecipe) {
			volbot.beetlebox.recipe.UpgradeRecipe.Serializer.SHAPED.write(packetByteBuf, shapedRecipe);
		}
	}
}

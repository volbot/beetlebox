...
public class BeetleRegistry {
	...
	public static final Item GELATIN = new Item(new FabricItemSettings().group(BeetleRegistry.ITEM_GROUP));
	public static final Item SUGAR_GELATIN = new Item(new FabricItemSettings().group(BeetleRegistry.ITEM_GROUP));
	public static final Item GELATIN_GLUE = new Item(new FabricItemSettings().group(BeetleRegistry.ITEM_GROUP));

	public static final Item APPLE_SYRUP = new FruitSyrup(new FabricItemSettings().group(BeetleRegistry.ITEM_GROUP));
	public static final Item MELON_SYRUP = new FruitSyrup(new FabricItemSettings().group(BeetleRegistry.ITEM_GROUP));
	public static final Item BERRY_SYRUP = new FruitSyrup(new FabricItemSettings().group(BeetleRegistry.ITEM_GROUP));
	public static final Item SUGAR_SYRUP = new FruitSyrup(new FabricItemSettings().group(BeetleRegistry.ITEM_GROUP));
	public static final Item CACTUS_SYRUP = new FruitSyrup(new FabricItemSettings());

	public static final Item NET = new NetItem(new FabricItemSettings().group(BeetleRegistry.ITEM_GROUP));

	public static final Item BEETLE_JAR = new BeetleJarItem<BeetleEntity>(
			new FabricItemSettings().group(BeetleRegistry.ITEM_GROUP), BeetleEntity.class);
	public static final Item LEG_BEETLE_JAR = new BeetleJarItem<LivingEntity>(
			new FabricItemSettings().group(BeetleRegistry.ITEM_GROUP).rarity(Rarity.UNCOMMON), LivingEntity.class);
	...
	public static final Item TANK_ITEM = new BlockItem(TANK, new FabricItemSettings().group(BeetleRegistry.ITEM_GROUP));
	...
	public static final Item LEG_TANK_ITEM = new BlockItem(LEG_TANK,
			new FabricItemSettings().group(BeetleRegistry.ITEM_GROUP).rarity(Rarity.UNCOMMON));

	public static final Block BOILER = new BoilerBlock(FabricBlockSettings.of(Material.STONE).strength(4.0f));
	public static final Item BOILER_ITEM = new BlockItem(BOILER,
			new FabricItemSettings().group(BeetleRegistry.ITEM_GROUP));
	...
	public static final RecipeType<BoilingRecipe> BOILING_RECIPE_TYPE = Registry.register(Registry.RECIPE_TYPE,
	...
	public static void register() {
		...
		Registry.register(Registry.RECIPE_SERIALIZER, JellyMixRecipe.Serializer.ID, JellyMixRecipe.Serializer.INSTANCE);

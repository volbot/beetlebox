...
public class TitanHelmetModel<T extends LivingEntity> extends BeetleArmorEntityModel<T>{
	...
	head.addChild("horn", ModelPartBuilder.create(), ModelTransform.of(-0.5F, -12.2989F, -7.8422F, -0.48F, 0.0F, 0.0F));
	...
	horn3.addChild("cube_r1", ModelPartBuilder.create().uv(24, 0).mirrored().cuboid(-5.7338F, 0.2738F, -2.9338F, 2.0F, 2.0F, 4.0F).mirrored(false), ModelTransform.of(0.0F, 1.4974F, -1.8342F, -0.6545F, 0.0F, 0.0F));

	horn3.addChild("cube_r2", ModelPartBuilder.create().uv(23, 16).mirrored().cuboid(-5.7338F, -0.4156F, -4.2675F, 2.0F, 2.0F, 7.0F).mirrored(false), ModelTransform.of(0.0F, 2.0405F, 1.648F, 0.0873F, 0.0F, 0.0F));
	...
	horn2.addChild("cube_r3", ModelPartBuilder.create().uv(24, 0).cuboid(3.7338F, 0.2738F, -2.9338F, 2.0F, 2.0F, 4.0F), ModelTransform.of(0.0F, 1.4974F, -1.8342F, -0.6545F, 0.0F, 0.0F));

	horn2.addChild("cube_r4", ModelPartBuilder.create().uv(23, 16).cuboid(3.7338F, -0.4156F, -4.2675F, 2.0F, 2.0F, 7.0F), ModelTransform.of(0.0F, 2.0405F, 1.648F, 0.0873F, 0.0F, 0.0F));

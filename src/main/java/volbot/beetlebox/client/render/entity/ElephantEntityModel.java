...
public class ElephantEntityModel extends BeetleEntityModel<ElephantEntity> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		left_front_arm.addChild("RUA2_r1", ModelPartBuilder.create().uv(0, 11).mirrored().cuboid(-2.7482F, -0.8638F, -0.5F, 3.0F, 1.0F, 1.0F).mirrored(false), ModelTransform.of(2.7114F, -2.1791F, -2.1678F, 0.2391F, 0.5194F, 0.4565F));

		left_front_arm.addChild("RLA2_r1", ModelPartBuilder.create().uv(0, 13).mirrored().cuboid(-0.2518F, -0.8638F, -0.5F, 3.0F, 1.0F, 1.0F).mirrored(false), ModelTransform.of(2.7114F, -2.1791F, -2.1678F, 0.481F, 0.3133F, 1.0374F));
		...
		left_mid_arm.addChild("RUA1_r1", ModelPartBuilder.create().uv(0, 11).mirrored().cuboid(-2.7482F, -0.8638F, -0.5F, 3.0F, 1.0F, 1.0F).mirrored(false), ModelTransform.of(2.7114F, -2.1791F, -2.1678F, 0.2391F, 0.5194F, 0.4565F));

		left_mid_arm.addChild("RLA1_r1", ModelPartBuilder.create().uv(0, 13).mirrored().cuboid(-0.2518F, -0.8638F, -0.5F, 3.0F, 1.0F, 1.0F).mirrored(false), ModelTransform.of(2.7114F, -2.1791F, -2.1678F, 0.481F, 0.3133F, 1.0374F));
		...
		left_hind_arm.addChild("RUA2_r2", ModelPartBuilder.create().uv(0, 11).mirrored().cuboid(-2.7482F, -0.8638F, -0.5F, 3.0F, 1.0F, 1.0F).mirrored(false), ModelTransform.of(2.7114F, -2.1791F, -2.1678F, 0.2391F, 0.5194F, 0.4565F));

		left_hind_arm.addChild("RLA2_r2", ModelPartBuilder.create().uv(0, 13).mirrored().cuboid(-0.2518F, -0.8638F, -0.5F, 3.0F, 1.0F, 1.0F).mirrored(false), ModelTransform.of(2.7114F, -2.1791F, -2.1678F, 0.481F, 0.3133F, 1.0374F));
		...
		right_front_arm.addChild("RUA3_r1", ModelPartBuilder.create().uv(0, 11).cuboid(-0.2518F, -0.8638F, -0.5F, 3.0F, 1.0F, 1.0F), ModelTransform.of(-2.7114F, -2.1791F, -2.1678F, 0.2391F, -0.5194F, -0.4565F));

		right_front_arm.addChild("RLA3_r1", ModelPartBuilder.create().uv(0, 13).cuboid(-2.7482F, -0.8638F, -0.5F, 3.0F, 1.0F, 1.0F), ModelTransform.of(-2.7114F, -2.1791F, -2.1678F, 0.481F, -0.3133F, -1.0374F));
		...
		right_mid_arm.addChild("RUA2_r3", ModelPartBuilder.create().uv(0, 11).cuboid(-0.2518F, -0.8638F, -0.5F, 3.0F, 1.0F, 1.0F), ModelTransform.of(-2.7114F, -2.1791F, -2.1678F, 0.2391F, -0.5194F, -0.4565F));

		right_mid_arm.addChild("RLA2_r3", ModelPartBuilder.create().uv(0, 13).cuboid(-2.7482F, -0.8638F, -0.5F, 3.0F, 1.0F, 1.0F), ModelTransform.of(-2.7114F, -2.1791F, -2.1678F, 0.481F, -0.3133F, -1.0374F));
		...
		right_hind_arm.addChild("RUA3_r2", ModelPartBuilder.create().uv(0, 11).cuboid(-0.2518F, -0.8638F, -0.5F, 3.0F, 1.0F, 1.0F), ModelTransform.of(-2.7114F, -2.1791F, -2.1678F, 0.2391F, -0.5194F, -0.4565F));

		right_hind_arm.addChild("RLA3_r2", ModelPartBuilder.create().uv(0, 13).cuboid(-2.7482F, -0.8638F, -0.5F, 3.0F, 1.0F, 1.0F), ModelTransform.of(-2.7114F, -2.1791F, -2.1678F, 0.481F, -0.3133F, -1.0374F));

		ModelPartData horn = head.addChild("horn", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, -1.5706F, -1.3191F));

		horn.addChild("cube_r3", ModelPartBuilder.create().uv(0, 0).cuboid(-0.5F, -0.5F, -1.0F, 1.0F, 1.0F, 3.0F), ModelTransform.of(0.0F, 1.7284F, -1.6932F, -0.5236F, 0.0F, 0.0F));

		horn.addChild("cube_r4", ModelPartBuilder.create().uv(0, 4).cuboid(-0.5F, -1.75F, -0.75F, 1.0F, 2.0F, 2.0F), ModelTransform.of(0.0F, 3.3552F, -1.2856F, 0.2182F, 0.0F, 0.0F));

		horn.addChild("cube_r5", ModelPartBuilder.create().uv(4, 4).cuboid(-0.5F, -1.25F, -0.5F, 1.0F, 1.0F, 1.0F), ModelTransform.of(0.0F, 4.1139F, -2.3977F, 0.2182F, 0.0F, 0.0F));

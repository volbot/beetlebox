		...
		if (entity.isFlying()) {
			if (!entity.isOnGround()) {
				...
				this.rightWing.pitch = 1.5966F
						+ (0.9336F * 1.3F) * MathHelper.sin(animationProgress * (float) Math.PI / 2.4F);
				this.rightWing.yaw = -0.60875F
						+ (0.24065F * 1.3F) * MathHelper.sin(animationProgress * (float) Math.PI / 2.4F);
				this.rightWing.roll = -1.6421F
						- (0.8506F * 1.3F) * MathHelper.sin(animationProgress * (float) Math.PI / 2.4F);
